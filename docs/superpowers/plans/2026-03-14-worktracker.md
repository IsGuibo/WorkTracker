...
- [x] **Step 2: 更新 WorkTrackerApp 接入 DataStore**
...
- [x] **Step 3: 更新 ContentView 为 NavigationSplitView**
...
- [x] **Step 2: 构建验证（GanttBarView 和 DayDetailView 先用占位）**
...
- [x] **Step 3: 更新 ContentView 接入日历视图**
